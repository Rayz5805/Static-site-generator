...
"""
        ...
        self.assertEqual(html_content, "<div><h1>Big heading</h1><h3>small heading</h3><p>parasyndrom <b>REDUCTED</b> can be danger here is the thingy <a href='https://huh.com'>web</a></p><ul><li>idk <i>thing</i></li><li>idk <code>thong</code></li><li>idk thang</li></ul><p>another paragraph with !<a href='/stuff/bee.png'>image</a>, that's the <i>best</i> part</p><ol><li>be</li><li><b>bee</b></li><li>beee</li><li>beeee</li></ol><blockquote>My word is good because it spelled like that</blockquote><pre><code>my code\nnext _line_ of code\n</code></pre></div>")
